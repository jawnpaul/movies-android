package com.example.moviesapp.movies.adapter
...
import com.example.moviesapp.databinding.SingleMovieItemBinding
...
class MoviesAdapter(private val onClick: MovieClickListener) :
    ...
    class ViewHolder private constructor(private val binding: SingleMovieItemBinding) :
